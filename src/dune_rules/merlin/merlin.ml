...
module Processed = struct
  ...
  let to_sexp ~opens ~pp ~reader { stdlib_dir; obj_dirs; src_dirs; flags; extensions; melc_flags } =
  ...
  let pp_flags sctx ~expander lib_name preprocess
    ...
    | Pps { loc; pps; flags; staged = _ } ->
      ...
      let+ exe, flags =
        ...
        Preprocessing.get_ppx_driver sctx ~loc ~expander ~lib_name ~flags ~scope pps
      in
